...
(function ($, undefined) {
    ...
    $.fn.gantt = function (options) {
        ...
        var core = {
            ...
            jQuery("#pg_num").text("1"+"/"+element.pageCount);
                /* core.render(element); */
            ...
            leftPanel: function (element) {
              ...
              /*  var ganttLeftPanel = $('<div class="leftPanel"/>')
                    ...
                    .css("width", "100%"));*/
					 ...
					 var ganttLeftPanel = $('<div class="leftPanel"/>')
                    .append($('<div class="row spacer"/>').append($('<div class="row name row0" style="height: 24px;"><span class="fn-label">'+element.data[0].optname+'</span></div><div class="row desc row0" style="height: 24px;"><span class="fn-label"><b>{!createdDateString}</b></span></div><div class="row desc row0" style="height: 24px;"><span class="fn-label"><b>Award Date</b></span></div>'))
            ...
            navigatePage: function (element, val) {
                if ((element.pageNum + val) >= 0 && (element.pageNum + val) < Math.ceil(element.rowsNum / settings.itemsPerPage)) {
                    core.waitToggle(element, true, function () {
                        ...
                        core.init(element);
						console.log("Page Number"+element.pageNum);
						jQuery("#pg_num").text(element.pageNum+"/"+element.pageCount);
